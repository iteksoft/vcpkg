...
#    link_directories("${CMAKE_VCLibDir}" "${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}" "${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}")
    ...
    set(CMAKE_EXE_LINKER_FLAGS "-LIBPATH:\"${CMAKE_VCLibDir}\" -LIBPATH:\"${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}\" -LIBPATH:\"${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}\"" CACHE STRING "" FORCE)
