...
#    link_directories("${CMAKE_VCLibDir}" "${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}" "${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}")
    ...
    set(CMAKE_EXE_LINKER_FLAGS "-LIBPATH:\"${MSVC_VCTOOLS_LIBDIR}\" -LIBPATH:\"${MSVC_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}\" -LIBPATH:\"${MSVC_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}\"" CACHE STRING "" FORCE)
