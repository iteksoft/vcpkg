...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    # it will
    set(ZZ_CMAKE_CXX_LINK_DIRECTORIES "${CMAKE_VCLibDir}\\;${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}\\;${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}" CACHE STRING "")
#    set(ZZ_CMAKE_CXX_LINK_DIRECTORIES "${CMAKE_VCLibDir}")
#    set(CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES "\"${CMAKE_VCLibDir}\" \"${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}\" \"${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}\"" CACHE STRING "")
#    set(ZZ_CMAKE_CXX_LINK_DIRECTORIES "c:/temp")
    message(STATUS "implicit is ${ZZ_CMAKE_CXX_LINK_DIRECTORIES}")
#    set(CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES "${CMAKE_VCLibDir}" "${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}" "${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}" CACHE INTERNAL "")

#    set(CMAKE_C_IMPLICIT_LINK_DIRECTORIES "${CMAKE_VCLibDir};${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE};${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}" CACHE STRING "")

#    set(LINK_DIRECTORIES "${CMAKE_VCLibDir}" "${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}" "${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}" CACHE INTERNAL "")
    #
...
#    message(STATUS "prop LINK_DIRECTORIES is  ${LINK_DIRECTORIES}")
#    list(APPEND LINK_DIRECTORIES "${CMAKE_VCLibDir}" "${CMAKE_WINDOWS_KITS_LIBDIR}/um/${VCPKG_TARGET_ARCHITECTURE}" "${CMAKE_WINDOWS_KITS_LIBDIR}/ucrt/${VCPKG_TARGET_ARCHITECTURE}")
